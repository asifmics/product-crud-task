...
<template>
    <div class="mx-auto">
        <div class="pb-3">
            <svg height="70px" width="70px" class="mx-auto" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
...
<g>
    ...
    <g>
        ...
        <div class="text-center">
            <h2 class="font-bold text-18 text-black py-2">No data found..</h2>
            <p class="font-normal text-black text-14">There is no data to show you right now</p>
        </div>
    </div>
</template>
